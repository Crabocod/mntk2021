<?php $this->extend('layouts/editor_auth'); ?>
...
<div class="auth__wrap">
    ...
    <div class="text-h2">Вход в панель редактора</div>
    <div class="a-form">
        <form action="#" id="auth">
            <div class="form-row">
            ...
            <div class="form-row">
                <label for="#">Выберите конференцию</label>
                <select name="conference_url">
...
<script src="/js/editor/auth-page.js?v=<?=\Config\SiteVersion::$main;?>"></script>
<?php $this->endSection(); ?>