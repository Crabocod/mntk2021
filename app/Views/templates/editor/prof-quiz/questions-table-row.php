<tr class="update-row">
    ...
    <td>
        <div class="row-item row-2-items">
            <input type="text" name="youtube_iframe" value="<?=esc(@$youtube_iframe);?>" placeholder="Код iframe" style="margin-bottom: 4px; width: 100%">
            <textarea name="text" class="height-100"><?=esc(@$text);?></textarea>
        </div>
    </td>
    <td>
        <form action="">
        ...
        <form action="">
            <div class="row-item row-file">
                <div class="thumbnail_div">
                    ...
                    <span><?=(!empty($file_title))?$file_title:'Прикрепить файл';?></span>
                    <img class="file__delete" src="/img/delete-krest.svg" style="<?=(!empty($file_title))?'':'display:none';?>">
